...
/** Coach-mark / FYP tutorial copy TikTok overlays on top of Home. */
...
/**
 * TikTok often drops a full-screen / center coach-mark on FYP after launch.
 * Those eat the Create (+) tap. While OCR still looks like a tutorial,
 * tap the middle of the screen until it clears (or we hit the attempt cap).
 */
